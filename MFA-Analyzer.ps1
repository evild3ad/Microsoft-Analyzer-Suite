...
<#
.SYNOPSIS
  MFA-Analyzer v0.1 - Automated Processing of 'MFAStatus.csv' (Microsoft-Extractor-Suite by Invictus-IR)

.DESCRIPTION
  MFA-Analyzer.ps1 is a PowerShell script utilized to simplify the analysis of the MFA Status of all users extracted via "Microsoft 365 Extractor Suite" by Invictus Incident Response.
...
$Host.UI.RawUI.WindowTitle = "MFA-Analyzer v0.1 - Automated Processing of 'MFAStatus.csv' (Microsoft-Extractor-Suite by Invictus-IR)"
...
# Header
Write-Output "MFA-Analyzer v0.1 - Automated Processing of 'MFAStatus.csv'"
